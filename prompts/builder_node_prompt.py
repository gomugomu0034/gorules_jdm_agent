from prompts.gorules_domain_knowledge.gorules_jdm_knowledge_base import GORULES_KNOWLEDGE_BASE, ADDITIONAL_DOMAIN_KNOWLEDGE_BASE, CRITICAL_CONSISTENCY_RULES, CRITICAL_DEBUGGING_KNOWLEDGE
